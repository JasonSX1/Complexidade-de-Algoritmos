...
public class Mesa extends Thread {
    ...
    public Mesa(String mesaId, ClienteImpl cliente, int rodadasPorJogador) {
        this.mesaId = mesaId;
        this.jogadores = new LinkedList<>(); // O(1) - Inicialização da lista vazia (agora LinkedList pra otimização no armazenamento)
    }
    ...
    public synchronized void adicionarJogador(Jogador jogador) {
        jogadores.add(jogador); // O(1) - Inserção ao final da lista
